...
public final class NameSearchResponseTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.name.server.model.NameSearchResponse#getMatches()}.
   */
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.name.server.model.NameSearchResponse#getTime()}.
   */
  @SuppressWarnings("static-method")
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.name.server.model.NameSearchResponse#NameSearchResponse(long, java.util.List)}.
   */
