...
public final class NodeNameTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.name.model.NodeName#getKeys()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.name.model.NodeName#getName()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.name.model.NodeName#getNodeId()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.name.model.NodeName#getRecordId()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.name.model.NodeName#getScore()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.name.model.NodeName#getSize()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.name.model.NodeName#NodeName(int, long, java.lang.String, de.zabuza.lexisearch.indexing.IKeyProvider)}.
   */
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.name.model.NodeName#NodeName(int, long, java.lang.String, de.zabuza.lexisearch.indexing.IKeyProvider, int)}.
   */
  @SuppressWarnings("unused")
  @Test
