...
public final class NearestSearchRequestTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.nearest.server.model.NearestSearchRequest#getLatitude()}.
   */
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.nearest.server.model.NearestSearchRequest#getLongitude()}.
   */
  @SuppressWarnings("static-method")
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.searching.nearest.server.model.NearestSearchRequest#NearestSearchRequest(float, float)}.
   */
