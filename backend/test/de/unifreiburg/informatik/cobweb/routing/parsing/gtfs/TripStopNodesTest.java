...
public final class TripStopNodesTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.parsing.gtfs.TripStopNodes#getArrNode()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.parsing.gtfs.TripStopNodes#getArrTime()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.parsing.gtfs.TripStopNodes#getDepNode()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.parsing.gtfs.TripStopNodes#getDepTime()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.parsing.gtfs.TripStopNodes#TripStopNodes(de.unifreiburg.informatik.cobweb.routing.model.graph.INode, de.unifreiburg.informatik.cobweb.routing.model.graph.INode, int, int)}.
   */
