...
import de.unifreiburg.informatik.cobweb.routing.model.graph.transit.ITransitIdGenerator;
...
public final class GtfsConnectionBuilderTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.parsing.gtfs.GtfsConnectionBuilder#buildEdge(de.unifreiburg.informatik.cobweb.routing.model.graph.ICoreNode, de.unifreiburg.informatik.cobweb.routing.model.graph.ICoreNode, double)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.parsing.gtfs.GtfsConnectionBuilder#buildNode(float, float, int)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.parsing.gtfs.GtfsConnectionBuilder#GtfsConnectionBuilder(de.unifreiburg.informatik.cobweb.routing.model.graph.transit.ITransitIdGenerator)}.
   */
