...
public final class FootpathTransitEdgeTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.algorithms.shortestpath.connectionscan.FootpathTransitEdge#FootpathTransitEdge(int, de.unifreiburg.informatik.cobweb.routing.model.graph.ICoreNode, de.unifreiburg.informatik.cobweb.routing.model.graph.ICoreNode, double)}.
   */
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.algorithms.shortestpath.connectionscan.FootpathTransitEdge#getTransportationModes()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.algorithms.shortestpath.connectionscan.FootpathTransitEdge#hasTransportationMode(de.unifreiburg.informatik.cobweb.routing.model.graph.ETransportationMode)}.
   */
  @Test
