...
public final class RouteElementTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.server.model.RouteElement#getGeom()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.server.model.RouteElement#getMode()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.server.model.RouteElement#getName()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.server.model.RouteElement#getType()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.server.model.RouteElement#RouteElement(de.unifreiburg.informatik.cobweb.routing.server.model.ERouteElementType, de.unifreiburg.informatik.cobweb.routing.model.graph.ETransportationMode, java.lang.String, java.util.List)}.
   */
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.server.model.RouteElement#RouteElement(de.unifreiburg.informatik.cobweb.routing.server.model.ERouteElementType, java.lang.String, java.util.List)}.
   */
  @SuppressWarnings({ "unused", "static-method" })
  @Test
