...
public final class StopTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.timetable.Stop#equals(java.lang.Object)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.timetable.Stop#getId()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.timetable.Stop#getLatitude()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.timetable.Stop#getLongitude()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.timetable.Stop#hashCode()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.timetable.Stop#setLatitude(float)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.timetable.Stop#setLongitude(float)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.timetable.Stop#Stop(int, float, float)}.
   */
