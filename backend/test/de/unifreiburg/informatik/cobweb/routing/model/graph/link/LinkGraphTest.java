...
public final class LinkGraphTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.link.LinkGraph#addEdge(ICoreEdge)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.link.LinkGraph#addNode(ICoreNode)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.link.LinkGraph#containsNodeWithId(int)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.link.LinkGraph#getNodeById(int)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.link.LinkGraph#getNodes()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.link.LinkGraph#isReversed()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.link.LinkGraph#LinkGraph(RoadGraph, TransitGraph)}.
   */
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.link.LinkGraph#removeNode(ICoreNode)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.link.LinkGraph#reverse()}.
   */
  @Test
