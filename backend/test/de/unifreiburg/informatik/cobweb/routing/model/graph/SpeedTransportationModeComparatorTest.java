...
public final class SpeedTransportationModeComparatorTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.SpeedTransportationModeComparator#compare(de.unifreiburg.informatik.cobweb.routing.model.graph.ETransportationMode, de.unifreiburg.informatik.cobweb.routing.model.graph.ETransportationMode)}.
   */
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.SpeedTransportationModeComparator#SpeedTransportationModeComparator()}.
   */
