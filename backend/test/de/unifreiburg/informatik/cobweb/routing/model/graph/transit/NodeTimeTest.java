...
public final class NodeTimeTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.NodeTime#compareTo(de.unifreiburg.informatik.cobweb.routing.model.graph.transit.NodeTime)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.NodeTime#getNode()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.NodeTime#getTime()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.NodeTime#NodeTime(de.unifreiburg.informatik.cobweb.routing.model.graph.INode, int)}.
   */
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.NodeTime#setTime(int)}.
   */
  @Test
