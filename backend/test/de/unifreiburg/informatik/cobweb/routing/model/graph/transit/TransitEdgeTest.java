...
public final class TransitEdgeTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.TransitEdge#equals(java.lang.Object)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.TransitEdge#getCost()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.TransitEdge#getDestination()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.TransitEdge#getId()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.TransitEdge#getSource()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.TransitEdge#hashCode()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.TransitEdge#setReversedProvider(de.unifreiburg.informatik.cobweb.routing.model.graph.IReversedProvider)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.routing.model.graph.transit.TransitEdge#TransitEdge(int, de.unifreiburg.informatik.cobweb.routing.model.graph.ICoreNode, de.unifreiburg.informatik.cobweb.routing.model.graph.ICoreNode, double)}.
   */
