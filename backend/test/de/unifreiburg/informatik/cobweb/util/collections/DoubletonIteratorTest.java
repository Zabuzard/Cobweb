...
public final class DoubletonIteratorTest {
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.util.collections.DoubletonIterator#DoubletonIterator(java.util.Iterator, java.util.Iterator)}.
   */
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.util.collections.DoubletonIterator#hasNext()}.
   */
  ...
  /**
   * Test method for
   * {@link de.unifreiburg.informatik.cobweb.util.collections.DoubletonIterator#next()}.
   */
  @SuppressWarnings("static-method")
  @Test
