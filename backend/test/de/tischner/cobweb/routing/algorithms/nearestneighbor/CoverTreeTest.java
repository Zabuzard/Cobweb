...
public final class CoverTreeTest {
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.nearestneighbor.CoverTree#CoverTree(de.tischner.cobweb.routing.algorithms.metrics.IMetric)}.
   */
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.nearestneighbor.CoverTree#getNearestNeighbor(de.tischner.cobweb.routing.model.graph.ISpatial)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.nearestneighbor.CoverTree#insert(de.tischner.cobweb.routing.model.graph.ISpatial)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.nearestneighbor.CoverTree#setBounds(float, float, float, float)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.nearestneighbor.CoverTree#size()}.
   */
  @Test
