...
public final class PathCostTest {
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.shortestpath.PathCost#getPathCost()}.
   */
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.shortestpath.PathCost#PathCost(double)}.
   */
