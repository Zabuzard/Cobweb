...
public final class ConnectionScanResultTest {
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.shortestpath.connectionscan.ConnectionScanResult#ConnectionScanResult(int[], de.tischner.cobweb.routing.algorithms.shortestpath.connectionscan.JourneyPointer[])}.
   */
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.shortestpath.connectionscan.ConnectionScanResult#getStopToArrTime()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.shortestpath.connectionscan.ConnectionScanResult#getStopToJourney()}.
   */
  @Test
