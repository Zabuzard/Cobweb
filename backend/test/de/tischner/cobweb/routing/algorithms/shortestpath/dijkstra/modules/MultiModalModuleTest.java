...
public final class MultiModalModuleTest {
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.shortestpath.dijkstra.modules.MultiModalModule#considerEdgeForRelaxation(de.tischner.cobweb.routing.model.graph.IEdge, de.tischner.cobweb.routing.model.graph.INode)}.
   */
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.shortestpath.dijkstra.modules.MultiModalModule#MultiModalModule(java.util.Set)}.
   */
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.shortestpath.dijkstra.modules.MultiModalModule#of(java.util.Set)}.
   */
  @SuppressWarnings("static-method")
  @Test
  public void testOf() {
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.algorithms.shortestpath.dijkstra.modules.MultiModalModule#provideEdgeCost(de.tischner.cobweb.routing.model.graph.IEdge, double)}.
   */
  @SuppressWarnings("static-method")
  @Test
