...
public final class TransitStopTest {
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.graph.transit.TransitStop#getArrivalNodes()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.graph.transit.TransitStop#getLatitude()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.graph.transit.TransitStop#getLongitude()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.graph.transit.TransitStop#setLatitude(float)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.graph.transit.TransitStop#setLongitude(float)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.graph.transit.TransitStop#TransitStop(java.util.List, float, float)}.
   */
