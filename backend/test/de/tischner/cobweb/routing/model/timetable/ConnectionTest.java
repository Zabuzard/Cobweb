...
public final class ConnectionTest {
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Connection#compareTo(de.tischner.cobweb.routing.model.timetable.Connection)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Connection#Connection(int, int, int, int, int, int)}.
   */
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Connection#equals(java.lang.Object)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Connection#getArrStopId()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Connection#getArrTime()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Connection#getDepStopId()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Connection#getDepTime()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Connection#getSequenceIndex()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Connection#getTripId()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Connection#hashCode()}.
   */
  @Test
