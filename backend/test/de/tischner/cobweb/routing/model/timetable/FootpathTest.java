...
public final class FootpathTest {
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Footpath#Footpath(int, int, int)}.
   */
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Footpath#getArrStopId()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Footpath#getDepStopId()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.routing.model.timetable.Footpath#getDuration()}.
   */
  @Test
