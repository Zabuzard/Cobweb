...
public final class RangedOverflowListIteratorTest {
  /**
   * Test method for
   * {@link de.tischner.cobweb.util.collections.RangedListIterator#hasNext()}.
   */
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.util.collections.RangedListIterator#next()}.
   */
  @SuppressWarnings("static-method")
  @Test
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.util.collections.RangedOverflowListIterator#RangedOverflowListIterator(java.util.List, int)}.
   */
  ...
  /**
   * Test method for
   * {@link de.tischner.cobweb.util.collections.RangedOverflowListIterator#RangedOverflowListIterator(java.util.List, int, int)}.
   */
  @SuppressWarnings({ "unused" })
  @Test
