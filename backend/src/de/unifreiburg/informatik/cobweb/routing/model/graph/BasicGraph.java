...
public final class BasicGraph extends AGraph<BasicNode, BasicEdge<BasicNode>> implements IGetNodeById<BasicNode> {
   ...
   * (non-Javadoc)
   * @see
   * de.unifreiburg.informatik.cobweb.routing.model.graph.IGraph#addNode(de.
   * uni_freiburg.informatik.cobweb. routing.model.graph.INode)
   */
  @Override
   ...
   * (non-Javadoc)
   * @see
   * de.unifreiburg.informatik.cobweb.routing.model.graph.road.ICanGetNodeById#
   ...
   * (non-Javadoc)
   * @see
   * de.unifreiburg.informatik.cobweb.routing.model.graph.IGraph#removeNode(de.
  ...
  /*
   * (non-Javadoc)
   * @see de.unifreiburg.informatik.cobweb.routing.model.graph.AGraph#
   * constructEdgeSetWith(de. tischner.cobweb.routing.model.graph.IEdge)
   */
  @Override
